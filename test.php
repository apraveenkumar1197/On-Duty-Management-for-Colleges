...
<body>
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="examples.html">SUBMITTED ODs</a></li>
          <li><a href="page.html">Change Password</a></li>
...
<form action="submittedod.php" method="get">
<input type="submit" value="SEE SUBMITTED OD">
</form>
  </form>
</div>
</body>
